...
&emsp;在 看来，Markdown就是HTML的简化版、TXT文本的格式版。如果你在编写中存在难点，你可以直接在Markdown中使用HTML标记语言（包括使用行内样式）。 
...
```
"markdown.styles": [
  "E:\\MyWeb\\ -study\\Document-Library\\Public-Repertory\\css\\markdown-github.css"
]
```
...
`<p>你好使用者，要看看 的网站吗？<a href="http://www. .top">点我跳转</a></p>`
